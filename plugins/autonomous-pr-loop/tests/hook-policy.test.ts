...
describe("hook policy", () => {
  ...
  it("allows normal delivery workflow commands", () => {
    for (const command of [
      ...
      { file: "mkdir", args: ["-p", "/tmp/holo-pack"] },
      { file: "mkdir", args: ["-p", "/var/folders/abc/def/T/holo-pack"] },
      ...
      { file: "git", args: ["ls-remote", "origin", "refs/heads/main"] },
      { file: "git", args: ["ls-remote", "origin", "refs/tags/v0.1.2"] },
      ...
      { file: "git", args: ["branch", "-d", "codex/issue-28-relax-hook-policy"] },
      ...
      { file: "gh", args: ["pr", "diff", "28", "--repo", "owner/repo", "--name-only"] },
      { file: "gh", args: ["pr", "diff", "28", "--repo", "owner/repo", "--patch", "--", "CHANGELOG.md"] },
      { file: "gh", args: ["pr", "comment", "28", "--repo", "owner/repo", "--body", "body"] },
      { file: "gh", args: ["api", "graphql", "--repo", "owner/repo", "-f", "query=query { viewer { login } }"] },
      { file: "gh", args: ["repo", "view", "owner/repo", "--json", "defaultBranchRef,nameWithOwner"] },
      { file: "gh", args: ["release", "view", "v0.1.2", "--repo", "owner/repo", "--json", "tagName,publishedAt,url"] },
      { file: "gh", args: ["release", "list", "--repo", "owner/repo", "--json", "tagName,publishedAt", "--limit", "10"] },
      ...
      { file: "pnpm", args: ["agent-loop", "delivery", "--help"] },
      { file: "pnpm", args: ["agent-loop", "run", "--help"] },
      ...
      { file: "agent-loop", args: ["release", "doctor", "--json"] },
  ...
  it("blocks git reset --hard with global -C variants", () => {
    for (const command of [
      ...
      { file: "git", args: ["-C", "/tmp/other", "log", "--oneline"] },
      { file: "git", args: ["--git-dir=/tmp/other/.git", "status"] },
      { file: "git", args: ["--work-tree=/tmp/other", "status"] },
      { file: "git", args: ["ls-remote", "https://example.com/repo.git"] },
      { file: "git", args: ["ls-remote", "origin", "refs/tags/latest"] },
      { file: "git", args: ["tag", "v0.1.3"] },
      { file: "git", args: ["branch", "-D", "codex/issue-28-relax-hook-policy"] },
      { file: "git", args: ["branch", "-d", "main"] },
      { file: "git", args: ["branch", "-d", "feature/manual"] },
      ...
      { file: "gh", args: ["repo", "view", "other/repo", "--json", "defaultBranchRef,nameWithOwner"] },
      { file: "gh", args: ["release", "create", "v0.1.3", "--repo", "owner/repo"] },
      { file: "gh", args: ["release", "list", "--repo", "owner/repo", "--json", "tagName,publishedAt,url", "--limit", "10"] },
      { file: "gh", args: ["release", "view", "latest", "--repo", "owner/repo", "--json", "tagName"] },
      { file: "gh", args: ["release", "view", "v0.1.2", "--repo", "other/repo", "--json", "tagName"] },
      { file: "gh", args: ["issue", "view", "1", "--repo", "other/repo"] },
      { file: "gh", args: ["issue", "view", "1", "-R=other/repo"] },
      { file: "gh", args: ["issue", "view", "1", "-Rother/repo"] },
      { file: "gh", args: ["issue", "view", "1", "--hostname", "evil.example"] },
      ...
      { file: "env", args: ["GH_HOST=evil.example", "gh", "issue", "view", "1"] },
      { file: "env", args: ["GIT_DIR=/tmp/other/.git", "git", "log", "--oneline"] },
      { file: "gh", args: ["issue", "create", "--title", "x", "--body", "body"] },
      { file: "gh", args: ["pr", "diff", "28", "--repo", "other/repo", "--name-only"] },
      { file: "gh", args: ["pr", "diff", "28", "--repo", "owner/repo", "--patch", "--", "../secret"] },
      ...
      { file: "pnpm", args: ["agent-loop", "dashboard", "smoke", "--host", "example.com"] },
      { file: "pnpm", args: ["agent-loop", "dashboard", "smoke", "--host", "::1"] },
      { file: "pnpm", args: ["agent-loop", "dashboard", "smoke", "--port", "70000"] },
      { file: "pnpm", args: ["agent-loop", "dashboard", "smoke", "--bad"] },
      { file: "pnpm", args: ["agent-loop", "release", "doctor", "--tag", "latest"] },
      ...
      { file: "pnpm", args: ["exec", "vitest", "-c", "/tmp/vitest.config.ts"] },
      { file: "pnpm", args: ["view", "holo-codex", "--registry=https://example.com"] },
      { file: "pnpm", args: ["pack", "--dry-run"] },
      { file: "pnpm", args: ["pack", "--dry-run", "--ignore-scripts", "--registry=https://example.com"] },
      ...
      { file: "npm", args: ["install", "--prefix", "/tmp/holo-smoke", "--ignore-scripts", "--registry=https://example.com", "holo-codex"] },
      ...
      { file: "mkdir", args: ["-p", "/tmp/not-holo-pack"] },
      { file: "mkdir", args: ["-p", "/tmp/holo-pack/.."] },
      ...
      { file: "curl", args: ["--head", "http://127.0.0.1:3000/health", "--url=http://evil.example/"] },
      { file: "curl", args: ["-w", "@~/.config/gh/hosts.yml", "http://127.0.0.1:3000/health"] },
      { file: "curl", args: ["-D", "/tmp/headers", "http://127.0.0.1:3000/health"] },
